...
PEP: 3118 Title: Revising the buffer protocol Author: Travis Oliphant \<oliphant@ee.byu.edu\>, Carl Banks \<pythondev@aerojockey.com\> Status: Final Type: Standards Track Created: 28-Aug-2006 Python-Version: 3.0 Post-History: [09-Apr-2007](https://mail.python.org/archives/list/python-dev@python.org/thread/X7A5IP4VFJTVCQJSMBXGAH3BVB3A5C3T)

<div class="canonical-doc">

`bufferobjects`, `PyBufferProcs`, `PyMemoryView_FromObject`

Not all features proposed here were implemented. Specifically:

- `PyObject_CopyToObject` was not added.
- `3118-struct-additions` were not added, except for `?` (`_Bool`).
- `PyObject_GetMemoryView` is named `PyMemoryView_FromObject`.
...
<tr>
<td>'?'</td>
<td>platform <span id="bool">Bool</span> type</td>
</tr>
<tr>
<td>'g'</td>
<td>long double</td>
...
<td>'X{}'</td>
<td><dl>
<dt>pointer to a function (optional function</dt>
<dd>
<p>signature inside {} with any return value preceded by -&gt; and placed at the end)</p>
</dd>
</dl></td>
</tr>
</tbody>
