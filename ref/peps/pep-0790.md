...
PEP: 790 Title: Python 3.15 Release Schedule Author: Hugo van Kemenade Status: Active Type: Informational Topic: Release Created: 26-Apr-2025 Python-Version: 3.15
...
The dates below use a 17-month development period that results in a 12-month release cadence between feature versions, as defined by `602`.
...
- Around the time of the release of 3.17.0 final, the final 3.15 bugfix update will be released.
