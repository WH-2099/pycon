...
PEP: 3121 Title: Extension Module Initialization and Finalization Author: Martin von Löwis \<martin@v.loewis.de\> Status: Final Type: Standards Track Created: 27-Apr-2007 Python-Version: 3.0 Post-History:
...
The entry point is currently called init\<module\>. This might conflict with other symbols also called init\<something\>. In particular, initsocket is known to have conflicted in the past (this specific problem got resolved as a side effect of renaming the module to <span id="socket">socket</span>).
...
[^1]: Tim Peters, reporting earlier conversation about such a feature <https://mail.python.org/pipermail/python-3000/2006-April/000726.html>
